...
def main():
    ...
    for attempt in range(max_attempts):
        try:
            ...
            print(f"Selected random page: {random_url} (Resource type: {resource_type})")
            ...
            if content and len(content) > 200:  # Require at least 200 chars
                ...
                # Display results
                print("\n" + "="*80)
                print(f"RESOURCE TYPE: {'Feynman Lectures' if resource_type == 'feynman' else 'Brennen Fluid Dynamics'}")
